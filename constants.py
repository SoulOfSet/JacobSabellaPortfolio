...
projects.append(Project("Twitics", "Given a Twitch user, show users that are not following them back.", None,
                      "https://twitics.jacobsabella.com"))

projects.append(Project("Associate Toolkit", "Android app for WalMart associates that displays barcodes for given items.",
                      None, "https://play.google.com/store/apps/details?id=com.soulworks.soulofset.associatetoolkit"))

projects.append(Project("Jacob Sabella Portfolio", "This website. Built on Flask using Bootstrap for the front end",
